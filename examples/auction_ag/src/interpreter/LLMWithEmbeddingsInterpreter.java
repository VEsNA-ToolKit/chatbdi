...
public class LLMWithEmbeddingsInterpreter extends Artifact implements Interpreter{
    ...
    private final String EMBEDDING_MODEL = "nomic-embed-text";//"granite-embedding";//"snowflake-arctic-embed";
    ...
    private JSONObject get_nl_to_logic_model() {
        String system = """
            ...
            Sentence: Which are the agents available?
            Answer: which_available_agents

            There are some sentences for which you should overpass the logical property provided:
             - if the user is asking which are the available agents you should answer which_available_agents
             - if the user is asking which are the available plans you should answer which_are_your_available_plans
        """;
